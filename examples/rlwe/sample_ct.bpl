...
// via /home/vagrant/verifying-constant-time/tools/smack/bin/smack.py -t --verifier=boogie --entry-points sample_ct_wrapper --unroll 1 --loop-limit 1 -bpl /home/vagrant/verifying-constant-time/examples/rlwe/sample_ct.bpl /home/vagrant/verifying-constant-time/examples/rlwe/rlwekex/rlwe_rand.c /home/vagrant/verifying-constant-time/examples/rlwe/rlwekex/rlwe.c /home/vagrant/verifying-constant-time/examples/rlwe/sample_ct.c
...
procedure {:inline 1} EVP_CIPHER_CTX_cleanup($p0: ref)
  returns ($r: i32);
procedure {:inline 1} EVP_CIPHER_CTX_init($p0: ref);
procedure {:inline 1} EVP_EncryptInit_ex($p0: ref, $p1: ref, $p2: ref, $p3: ref, $p4: ref)
  returns ($r: i32);
procedure {:inline 1} EVP_EncryptUpdate($p0: ref, $p1: ref, $p2: ref, $p3: ref, $i4: i32)
  returns ($r: i32);
procedure {:inline 1} EVP_aes_256_ctr()
  returns ($r: ref);
procedure {:inline 1} FFT_add($p0: ref, $p1: ref, $p2: ref);
procedure {:inline 1} FFT_mul($p0: ref, $p1: ref, $p2: ref, $p3: ref);
procedure {:inline 1} OPENSSL_cleanse($p0: ref, $i1: i64);
procedure {:inline 1} RANDOM192(r: ref, rand_ctx: ref)
{
  var $i5: i32;
  var $i6: i1;
  var $i8: i32;
...
$bb0:
  ...
  assume {:sourceloc "/home/vagrant/verifying-constant-time/examples/rlwe/rlwekex/rlwe_rand_openssl_aes.c", 49, 2} true;
  call $M.0 := $memset.i8($M.0, $p2, 0, 24, $zext.i32.i64(16), (0 == 1));
  ...
  $p4 := $p0;
  assume {:sourceloc "/home/vagrant/verifying-constant-time/examples/rlwe/rlwekex/rlwe_rand_openssl_aes.c", 52, 12} true;
  call $i5 := EVP_EncryptUpdate(rand_ctx, $p3, $p1, $p4, 24);
...
$bb1:
  ...
  assume {:sourceloc "/home/vagrant/verifying-constant-time/examples/rlwe/rlwekex/rlwe_rand_openssl_aes.c", 54, 3} true;
  call $i8 := fprintf.ref.ref($p7, .str990);
...
procedure {:inline 1} RANDOM32(rand_ctx: ref)
  returns ($r: i32)
{
  var $i0: i64;
  var $i1: i32;
...
procedure {:inline 1} RANDOM64(rand_ctx: ref)
  returns ($r: i64)
{
  var $i10: i32;
  var $i13: i64;
...
$bb0:
  ...
  assume {:sourceloc "/home/vagrant/verifying-constant-time/examples/rlwe/rlwekex/rlwe_rand_openssl_aes.c", 36, 2} true;
  call $M.0 := $memset.i8($M.0, $p3, 0, 16, $zext.i32.i64(16), (0 == 1));
  // WARNING: ignoring llvm.debug call.
  assume true;
  ...
  $p6 := $p0;
  assume {:sourceloc "/home/vagrant/verifying-constant-time/examples/rlwe/rlwekex/rlwe_rand_openssl_aes.c", 39, 12} true;
  call $i7 := EVP_EncryptUpdate(rand_ctx, $p5, $p2, $p6, 16);
...
$bb1:
  ...
  assume {:sourceloc "/home/vagrant/verifying-constant-time/examples/rlwe/rlwekex/rlwe_rand_openssl_aes.c", 41, 3} true;
  call $i10 := fprintf.ref.ref($p9, .str990);
...
procedure {:inline 1} RAND_bytes($p0: ref, $i1: i32)
  returns ($r: i32);
...
procedure {:inline 1} cmplt_ct(a: ref, b: ref)
  returns ($r: i32)
{
  var $i0: i64;
  var $i1: i64;
...
procedure {:inline 1} ct_isnonzero_u64(x: i64)
  returns ($r: i64)
{
  var $i0: i64;
  var $i1: i64;
...
procedure {:inline 1} ct_lt_u64(x: i64, y: i64)
  returns ($r: i64)
{
  var $i0: i64;
  var $i1: i64;
...
procedure {:inline 1} ct_mask_u64(bit: i64)
  returns ($r: i64)
{
  var $i0: i64;
  var $i1: i64;
...
procedure {:inline 1} ct_ne_u64(x: i64, y: i64)
  returns ($r: i64)
{
  var $i0: i64;
  var $i1: i64;
...
procedure {:inline 1} dbl(in: i32, e: i32)
  returns ($r: i64)
{
  var $i0: i32;
  var $i1: i32;
...
procedure {:inline 1} fprintf.ref.ref($p0: ref, $p1: ref)
  returns ($r: i32);
...
procedure {:inline 1} memset($p0: ref, $i1: i32, $i2: i64)
  returns ($r: ref);
procedure {:inline 1} public_in($p0: ref);
procedure {:inline 1} rlwe_sample_ct.ref.ref(p.0: ref, p.1: ref)
  returns ($r: i32);
procedure {:entrypoint} sample_ct_wrapper(s: ref, rand_ctx: ref)
{
  var $i2: i32;
  var $p0: ref;
  var $p1: ref;
$bb0:
  ...
  call {:name s} $p0 := __SMACK_value.ref(s);
  ...
  call {:name rand_ctx} $p1 := __SMACK_value.ref(rand_ctx);
