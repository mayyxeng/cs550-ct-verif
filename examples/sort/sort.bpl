...
// via /home/vagrant/verifying-constant-time/bin/../tools/smack/bin/smack.py -t --verifier=boogie --entry-points sort3_wrapper --unroll 1 --loop-limit 1 -bpl ../examples/sort/sort.bpl ../examples/sort/sort.c
...
procedure {:inline 1} __SMACK_return_value()
  returns ($r: ref);
...
procedure {:inline 1} __SMACK_value.ref(p: ref)
  returns ($r: ref);
...
procedure {:inline 1} sort2(out2: ref, in2: ref)
  returns ($r: i32)
{
  var $i1: i32;
  var $i12: i32;
...
procedure {:entrypoint} sort3_wrapper(conds: ref, out: ref, in: ref)
  returns ($r: ref)
{
  var $i1: i1;
  var $i10: i1;
